...
<artifact_info>
  ...
  - Use \`<appzaArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<appzaAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<appzaArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<appzaAction>\` tags with appropriate \`type\` attribute:
