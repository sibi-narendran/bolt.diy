...
describe('StreamingMessageParser', () => {
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <appzaArtifact title="Some title" id="artifact_1">foo bar</appzaArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <appzaArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</appzaArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</appzaArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</appzaArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <appzaArtifact title="Some title" id="artifact_1">foo</appzaArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <appzaArtifact title="Some title" id="artifact_1"><appzaAction type="shell">npm install</appzaAction></appzaArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <appzaArtifact title="Some title" id="artifact_1"><appzaAction type="shell">npm install</appzaAction><appzaAction type="file" filePath="index.js">some content</appzaAction></appzaArtifact> After',
        {
          output: 'Before  After',
