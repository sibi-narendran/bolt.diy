  ...
  if (isLoading) {
    return (
      <nav className="flex items-center gap-2">
        <div className="h-8 w-20 bg-bolt-elements-background-depth-2 animate-pulse rounded-md" />
      </nav>
    );
  }
        ...
        <Dropdown
          trigger={
            <Button
              variant="ghost"
              size="sm"
              className="flex items-center gap-2 text-bolt-elements-textPrimary bg-bolt-elements-background-depth-2 hover:bg-bolt-elements-background-depth-2"
