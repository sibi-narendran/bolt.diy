      ...
      chatStarted && (
        <>
          ...
          >
            <div
              className={classNames(
                'fixed top-[calc(var(--header-height)+1.2rem)] bottom-6 w-[var(--workbench-inner-width)] z-[45] transition-[left,width] duration-200 bolt-ease-cubic-bezier',
                {
            ...
            >
              <div className="absolute inset-0 px-2 lg:px-4">
                <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                  <div className="flex flex-wrap items-center gap-1.5 px-3 py-2 border-b border-bolt-elements-borderColor">
                    <button
