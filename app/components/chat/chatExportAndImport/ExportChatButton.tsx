...
export const ExportChatButton = ({ exportChat }: { exportChat?: () => void }) => {
  return (
    <div className="flex border border-appza-elements-borderColor rounded-md overflow-hidden">
      <DropdownMenu.Root>
        ...
        >
          <DropdownMenu.Item
            className={classNames(
              'cursor-pointer flex items-center w-auto px-4 py-2 text-sm text-appza-elements-textPrimary hover:bg-appza-elements-item-backgroundActive gap-2 rounded-md group relative',
            )}
            onClick={() => {
