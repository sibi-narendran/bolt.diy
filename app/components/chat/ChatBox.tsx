...
export const ChatBox: React.FC<ChatBoxProps> = (props) => {
  ...
  return (
    <div className="w-full max-w-chat mx-auto">
      <div className="relative flex flex-col gap-3 rounded-xl border border-bolt-elements-borderColor bg-bolt-elements-background-depth-2/95 backdrop-blur-xl p-3 sm:p-4 shadow-sm">
        <FilePreview
          files={uploadedFiles}
        ...
        {selectedElement && (
          <div className="flex items-center justify-between gap-2 rounded-lg border border-bolt-elements-borderColor bg-bolt-elements-background-depth-1/70 px-3 py-2 text-xs font-medium text-bolt-elements-textPrimary">
        ...
        <div className="relative rounded-lg border border-bolt-elements-borderColor/80 bg-bolt-elements-background-depth-1/70 transition-theme focus-within:border-bolt-elements-borderColorActive">
          <textarea
            ref={textareaRef}
            className="w-full resize-none bg-transparent px-3 sm:px-4 pt-3 sm:pt-4 pb-10 sm:pb-12 text-sm sm:text-base text-bolt-elements-textPrimary placeholder:text-bolt-elements-textTertiary outline-none transition-all duration-200"
            onDragEnter={(event) => {
            ...
            onDragLeave={(event) => {
              event.preventDefault();
              event.currentTarget.style.border = '1px solid var(--bolt-elements-borderColor)';
            }}
            onDrop={(event) => {
              event.preventDefault();
              event.currentTarget.style.border = '1px solid var(--bolt-elements-borderColor)';
