...
export function StatsDisplay({ stats, onRefresh, isRefreshing }: StatsDisplayProps) {
  return (
    <div className="space-y-4">
      {/* Repository Stats */}
      <div>
        <h5 className="text-sm font-medium text-appza-elements-textPrimary mb-2">Repository Stats</h5>
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div
              key={index}
              className="flex flex-col p-3 rounded-lg bg-appza-elements-background-depth-2 border border-appza-elements-borderColor"
            >
              <span className="text-xs text-appza-elements-textSecondary">{stat.label}</span>
              <span className="text-lg font-medium text-appza-elements-textPrimary">{stat.value}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Contribution Stats */}
      <div>
        <h5 className="text-sm font-medium text-appza-elements-textPrimary mb-2">Contribution Stats</h5>
