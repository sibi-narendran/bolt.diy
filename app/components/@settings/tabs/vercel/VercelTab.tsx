...
export default function VercelTab() {
  ...
  const renderProjects = useCallback(() => {
    if (fetchingStats) {
      return (
        <div className="flex items-center gap-2 text-sm text-appzap-elements-textSecondary">
          ...
          <div className="space-y-4 mt-4">
            ...
            {connection.stats?.projects?.length ? (
              <div className="mb-6 p-4 bg-appzap-elements-background-depth-1 rounded-lg border border-appzap-elements-borderColor">
                <h4 className="text-sm font-medium text-appzap-elements-textPrimary mb-3">Vercel Overview</h4>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-appzap-elements-textPrimary">
                      {connection.stats.totalProjects}
                    </div>
                    <div className="text-xs text-appzap-elements-textSecondary">Total Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-appzap-elements-textPrimary">
                      {
                    ...
                    <div className="text-xs text-appzap-elements-textSecondary">Deployed Projects</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-appzap-elements-textPrimary">
                      {new Set(connection.stats.projects.map((p) => p.framework).filter(Boolean)).size}
                    </div>
                    <div className="text-xs text-appzap-elements-textSecondary">Frameworks Used</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-appzap-elements-textPrimary">
                      {connection.stats.projects.filter((p) => p.latestDeployments?.[0]?.state === 'READY').length}
                    </div>
                    <div className="text-xs text-appzap-elements-textSecondary">Active Deployments</div>
                  </div>
                </div>
              </div>
            ) : null}
            ...
            {connection.stats?.projects?.length ? (
              <div className="mb-6 space-y-4">
                <h4 className="text-sm font-medium text-appzap-elements-textPrimary">Performance Analytics</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-appzap-elements-background-depth-2 p-3 rounded-lg border border-appzap-elements-borderColor">
                    <h6 className="text-xs font-medium text-appzap-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:rocket w-4 h-4 text-appzap-elements-item-contentAccent" />
                      Deployment Health
                    </h6>
                  ...
                  <div className="bg-appzap-elements-background-depth-2 p-3 rounded-lg border border-appzap-elements-borderColor">
                    <h6 className="text-xs font-medium text-appzap-elements-textPrimary flex items-center gap-2 mb-2">
                      <div className="i-ph:activity w-4 h-4 text-appzap-elements-item-contentAccent" />
                      Activity Summary
                    </h6>
                    <div className="space-y-1">
                      {(() => {
            ...
            {connection.stats?.projects?.length ? (
              <div className="mb-6">
                <h4 className="text-sm font-medium text-appzap-elements-textPrimary mb-2">Project Health Overview</h4>
            ...
            {connection.stats?.projects?.length ? (
              <div className="grid gap-3">
                {connection.stats.projects.map((project) => (
                  <div
                    key={project.id}
                    className="p-4 rounded-lg border border-appzap-elements-borderColor hover:border-appzap-elements-borderColorActive/70 transition-colors bg-appzap-elements-background-depth-1"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h5 className="text-sm font-medium text-appzap-elements-textPrimary flex items-center gap-2">
                          <div className="i-ph:globe w-4 h-4 text-appzap-elements-borderColorActive" />
                          {project.name}
                        </h5>
                        <div className="flex items-center gap-2 mt-2 text-xs text-appzap-elements-textSecondary">
                          {project.targets?.production?.alias && project.targets.production.alias.length > 0 ? (
                            <>
                              <a
                                ...
                                className="hover:text-appzap-elements-borderColorActive underline"
                              >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mt-3 pt-3 border-t border-appzap-elements-borderColor">
                          <div className="text-center">
                            <div className="text-sm font-semibold text-appzap-elements-textPrimary">
                              {/* Deployments - This would be fetched from API */}
                              --
                            </div>
                            <div className="text-xs text-appzap-elements-textSecondary flex items-center justify-center gap-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {project.framework && (
                          <div className="text-xs text-appzap-elements-textSecondary px-2 py-1 rounded-md bg-appzap-elements-background-depth-2">
                            <span className="flex items-center gap-1">
                    ...
                    <div className="flex items-center flex-wrap gap-1 mt-3 pt-3 border-t border-appzap-elements-borderColor">
                      {projectActions.map((action) => (
                        <Button
                          ...
                          className="flex items-center gap-1 text-xs px-2 py-1 text-appzap-elements-textPrimary dark:text-appzap-elements-textPrimary"
                        >
              ...
              <div className="text-sm text-appzap-elements-textSecondary flex items-center gap-2 p-4">
        ...
        <div className="p-6 space-y-6">
          {!connection.user ? (
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm text-appzap-elements-textSecondary mb-2">Personal Access Token</label>
                <input
                  type="password"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-appzap-elements-background-depth-1 dark:bg-appzap-elements-background-depth-1 rounded-lg">
                  <img
                    src={`https://vercel.com/api/www/avatar?u=${connection.user?.username}`}
                    referrerPolicy="no-referrer"
                    crossOrigin="anonymous"
                    alt="User Avatar"
                    className="w-12 h-12 rounded-full border-2 border-appzap-elements-borderColorActive"
                  />
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-appzap-elements-textPrimary">
                ...
                {/* Usage Metrics */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-3 bg-appzap-elements-background-depth-1 rounded-lg border border-appzap-elements-borderColor">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="i-ph:buildings w-4 h-4 text-appzap-elements-item-contentAccent" />
                      <span className="text-xs font-medium text-appzap-elements-textPrimary">Projects</span>
                    </div>
                    <div className="text-sm text-appzap-elements-textSecondary">
                      <div>
                        Active:{' '}
                        {connection.stats?.projects.filter((p) => p.latestDeployments?.[0]?.state === 'READY').length ||
                          0}
                  ...
                  <div className="p-3 bg-appzap-elements-background-depth-1 rounded-lg border border-appzap-elements-borderColor">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="i-ph:globe w-4 h-4 text-appzap-elements-item-contentAccent" />
                      <span className="text-xs font-medium text-appzap-elements-textPrimary">Domains</span>
                    </div>
                    <div className="text-sm text-appzap-elements-textSecondary">
                  ...
                  <div className="p-3 bg-appzap-elements-background-depth-1 rounded-lg border border-appzap-elements-borderColor">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="i-ph:activity w-4 h-4 text-appzap-elements-item-contentAccent" />
                      <span className="text-xs font-medium text-appzap-elements-textPrimary">Usage</span>
                    </div>
                    <div className="text-sm text-appzap-elements-textSecondary">
